...
public sealed class AnimationState.TrackEntryDelegate : MulticastDelegate
{
    ...
    {
        mem[1152921510534459424] = object;
        mem[1152921510534459432] = method;
        mem[1152921510534459408] = method;
    }
    public virtual void Invoke(Spine.TrackEntry trackEntry)
    {
        ...
        goto label_25;
        label_40:
        Spine.TrackEntry val_3 = 1152921504862277632 + ((X22 + 72) << 4);
        val_18 = mem[(1152921504862277632 + (X22 + 72) << 4) + 312];
        goto label_25;
        label_4:
        Spine.TrackEntry val_4 = 1152921504862277632 + val_16;
        goto label_25;
        label_31:
        if((trackEntry.Equals(obj:  mem[(1152921504862277632 + X22 + 72) + 304 + 8])) == false)
        {
            goto label_11;
        }
        ...
        goto label_25;
        label_46:
        val_16 = mem[1152921510534591904];
        if((mem[1152921510534591912] & 1) == 0)
        {
            goto label_23;
        }
        
        if((mem[1152921510534591912] + 74) == 1)
        {
            goto label_45;
        }
        ...
        if((((mem[1152921510534591912] + 72) == 1) || (((mem[1152921510534591904] + 273) & 1) != 0)) || ((mem[1152921510534591904] + 273) == 0))
        {
            goto label_25;
        }
        ...
        if((mem[1152921510534591904] + 294) == 0)
        {
            goto label_36;
        }
        
        var val_20 = mem[1152921510534591904] + 176;
        var val_21 = 0;
        val_20 = val_20 + 8;
        label_35:
        if(((mem[1152921510534591904] + 176 + 8) + -8) == (mem[1152921510534591912] + 24))
        {
            goto label_34;
        }
        ...
        val_21 = val_21 + 1;
        val_20 = val_20 + 16;
        if(val_21 < (mem[1152921510534591904] + 294))
        {
            goto label_35;
        }
        ...
        goto label_36;
        label_26:
        if(((mem[1152921510534591912] + 72) == 1) || ((mem[1152921510534591912] + 72) == 0))
        {
            goto label_45;
        }
        ...
        goto label_44;
        label_27:
        UnityEngine.Sprite val_11 = mem[1152921510534591912].disabledSprite;
        label_45:
        label_25:
        val_23 = val_23 + 1;
        if(val_23 != val_14)
