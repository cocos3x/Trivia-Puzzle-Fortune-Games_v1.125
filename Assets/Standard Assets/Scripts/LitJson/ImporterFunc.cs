...
namespace LitJson
{
    internal sealed class ImporterFunc : MulticastDelegate
    {
        ...
        {
            mem[1152921513337781040] = object;
            mem[1152921513337781048] = method;
            mem[1152921513337781024] = method;
        }
        public virtual object Invoke(object input)
        {
            ...
            goto label_25;
            label_46:
            val_15 = mem[1152921513337913520];
            if((mem[1152921513337913528] & 1) == 0)
            {
                goto label_23;
            }
            
            if((mem[1152921513337913528] + 74) == 1)
            {
                goto label_45;
            }
            ...
            if((((mem[1152921513337913528] + 72) == 1) || (((mem[1152921513337913520] + 273) & 1) != 0)) || ((mem[1152921513337913520] + 273) == 0))
            {
                goto label_30;
            }
            ...
            if((mem[1152921513337913520] + 294) == 0)
            {
                goto label_36;
            }
            
            var val_19 = mem[1152921513337913520] + 176;
            var val_20 = 0;
            val_19 = val_19 + 8;
            label_35:
            if(((mem[1152921513337913520] + 176 + 8) + -8) == (mem[1152921513337913528] + 24))
            {
                goto label_34;
            }
            ...
            val_20 = val_20 + 1;
            val_19 = val_19 + 16;
            if(val_20 < (mem[1152921513337913520] + 294))
            {
                goto label_35;
            }
            ...
            goto label_36;
            label_26:
            if(((mem[1152921513337913528] + 72) == 1) || ((mem[1152921513337913528] + 72) == 0))
            {
                goto label_45;
            }
            ...
            goto label_44;
            label_27:
            UnityEngine.Sprite val_10 = mem[1152921513337913528].disabledSprite;
            label_45:
            val_18 = input;
            label_25:
            val_22 = val_22 + 1;
