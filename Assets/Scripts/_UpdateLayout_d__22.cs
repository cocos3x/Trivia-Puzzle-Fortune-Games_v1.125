using UnityEngine;
private sealed class WGSettingsMiniPopup.<UpdateLayout>d__22 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    private int <>1__state;
    private object <>2__current;
    public WGSettingsMiniPopup <>4__this;
    ...
    // Methods
    public WGSettingsMiniPopup.<UpdateLayout>d__22(int <>1__state)
    {
