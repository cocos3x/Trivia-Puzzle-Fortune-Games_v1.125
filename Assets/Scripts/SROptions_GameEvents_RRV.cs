...
public class SROptions_GameEvents_RRV : SuperLuckySROptionsParent<SROptions_GameEvents_RRV>, INotifyPropertyChanged
{
    ...
    public void ToggleHackedSingleEvent()
    {
        ...
        SROptions_GameEvents_RRV.NotifyPropertyChanged(propertyName:  "CurrentSingleEvent");
    }
    public void CurrentEventInfoHud()
    {
        ...
        val_4 = null;
        val_4 = null;
        val_6 = SROptions_GameEvents_RRV.<>c.<>9__7_0;
        if(val_6 == null)
        {
                System.Func<System.String> val_1 = null;
            val_6 = val_1;
            val_1 = new System.Func<System.String>(object:  SROptions_GameEvents_RRV.<>c.__il2cppRuntimeField_static_fields, method:  System.String SROptions_GameEvents_RRV.<>c::<CurrentEventInfoHud>b__7_0());
            SROptions_GameEvents_RRV.<>c.<>9__7_0 = val_6;
        }
    ...
    public void PlayerLevelUp1()
    {
        ...
        SROptions_GameEvents_RRV.NotifyPropertyChanged(propertyName:  "Level");
    }
    ...
    private void ModifyAttackMadnessEventLevel(int val, bool isAbsoluteValue = False)
    {
        ...
        SROptions_GameEvents_RRV.NotifyPropertyChanged(propertyName:  "AtkMadnessPtsCollected");
        SROptions_GameEvents_RRV.NotifyPropertyChanged(propertyName:  "AtkMadnessRewardsCollected");
        SROptions_GameEvents_RRV.NotifyPropertyChanged(propertyName:  "AtkMadnessCurrentRewData");
    }
    ...
    private void ModifyRaidMadnessEventLevel(int val, bool isAbsoluteValue = False)
    {
        ...
        SROptions_GameEvents_RRV.NotifyPropertyChanged(propertyName:  "RaidMadnessPtsCollected");
        SROptions_GameEvents_RRV.NotifyPropertyChanged(propertyName:  "RaidMadnessRewardsCollected");
        SROptions_GameEvents_RRV.NotifyPropertyChanged(propertyName:  "RaidMadnessCurrentRewData");
    }
    ...
    public string get_HotNSpicyCurrentRewData()
    {
        var val_3;
        var val_4;
        if(((HotNSpicyEventHandler.<Instance>k__BackingField) != null) && ((HotNSpicyEventHandler.<Instance>k__BackingField) != null))
        {
                val_3 = HotNSpicyEventHandler.<Instance>k__BackingField;
            HotNSpicyEventHandler.<Instance>k__BackingField.__unknownFiledOffset_10 = HotNSpicyEventHandler.<Instance>k__BackingField + 24;
            string val_2 = System.String.Format(format:  "<color=#ffef00>{0} {1} - Pts Req: {2}</color>", arg0:  HotNSpicyEventHandler.<Instance>k__BackingField + 24, arg1:  HotNSpicyEventHandler.<Instance>k__BackingField + 24.ToString(), arg2:  HotNSpicyEventHandler.<Instance>k__BackingField + 20);
            return (string)val_4;
        }
    ...
    public string get_HotNSpicyRewardsCollected()
    {
        ...
        {
                string val_3 = "<color=#00ff00>"("<color=#00ff00>") + HotNSpicyEventHandler.<Instance>k__BackingField.ProgressLevel.ToString()(HotNSpicyEventHandler.<Instance>k__BackingField.ProgressLevel.ToString()) + "</color>"("</color>");
            return (string)val_4;
        }
    ...
    private void ModifyHotNSpicyEventLevel(int val, bool isAbsoluteValue = False)
    {
        ...
        if(isAbsoluteValue != false)
        {
                typeof(HotNSpicyProgress).__il2cppRuntimeField_1C = val;
        }
        else
        {
                typeof(HotNSpicyProgress).__il2cppRuntimeField_1C = UnityEngine.Mathf.Max(a:  0, b:  (val + val)>>0&0xFFFFFFFF);
        }
        
        typeof(HotNSpicyProgress).__il2cppRuntimeField_28 = 0;
        HotNSpicyEventHandler.<Instance>k__BackingField.UpdateProgressToServer();
        SROptions_GameEvents_RRV.NotifyPropertyChanged(propertyName:  "HotNSpicyPtsCollected");
        SROptions_GameEvents_RRV.NotifyPropertyChanged(propertyName:  "HotNSpicyRewardsCollected");
        SROptions_GameEvents_RRV.NotifyPropertyChanged(propertyName:  "HotNSpicyCurrentRewData");
    }
    ...
    public string get_HotNSpicyPtsCollected()
    {
        ...
        if((HotNSpicyEventHandler.<Instance>k__BackingField) != null)
        {
                string val_2 = "<color=#00ff00>"("<color=#00ff00>") + HotNSpicyEventHandler.<Instance>k__BackingField.ToString()(HotNSpicyEventHandler.<Instance>k__BackingField.ToString()) + "</color>"("</color>");
            return (string)val_3;
        }
    ...
    public void HotNSpicySkipToAlmostCurrentRewardPtsReq()
    {
        ...
        HotNSpicyEventHandler.<Instance>k__BackingField.ModifyHotNSpicyPointsCollected(val:  (HotNSpicyEventHandler.<Instance>k__BackingField + 20) - 1, isAbsoluteValue:  true);
    }
    public void HotNSpicySkipToAlmostFinalRewardPtsReq()
    {
        ...
        val_3.ModifyHotNSpicyPointsCollected(val:  val_1.pointsReq - 1, isAbsoluteValue:  true);
    }
