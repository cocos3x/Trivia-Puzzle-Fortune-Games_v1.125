...
public class RaidMadnessEcon
{
    ...
    public RaidMadnessEcon(System.Collections.Generic.Dictionary<string, object> eventDataDict)
    {
        ...
        this.pointsGainPerRaid = 1;
        this.avgPointPerSpinTier1 = 0.4603f;
        this.avgPointPerSpinTier2 = 0.40784f;
        this.avgPointPerSpinTier3 = 0.05752f;
        this.rewardData = RaidMadnessEconDataHelper.ParseCSV();
        ...
        {
                if((System.Single.TryParse(s:  val_20.Item["t1"], result: out  float val_24 = -9.015683E+08f)) != false)
        {
        ...
        {
                if((System.Single.TryParse(s:  val_20.Item["t2"], result: out  float val_29 = -9.01568E+08f)) != false)
        {
        ...
        if((System.Single.TryParse(s:  val_20.Item["t3"], result: out  float val_34 = -9.015677E+08f)) == false)
        {
                return;
        }
