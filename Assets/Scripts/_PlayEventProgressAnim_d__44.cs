using UnityEngine;
private sealed class WFOLevelClearPopup.<PlayEventProgressAnim>d__44 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public WFOLevelClearPopup.<PlayEventProgressAnim>d__44(int <>1__state)
    {
