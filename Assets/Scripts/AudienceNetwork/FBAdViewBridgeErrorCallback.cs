...
namespace AudienceNetwork
{
    public sealed class FBAdViewBridgeErrorCallback : MulticastDelegate
    {
        ...
        {
            mem[1152921520216049200] = object;
            mem[1152921520216049208] = method;
            mem[1152921520216049184] = method;
        }
        public virtual void Invoke(string error)
        {
            ...
            goto label_25;
            label_46:
            val_15 = mem[1152921520216181680];
            if((mem[1152921520216181688] & 1) == 0)
            {
                goto label_23;
            }
            
            if((mem[1152921520216181688] + 74) == 1)
            {
                goto label_45;
            }
            ...
            if((((mem[1152921520216181688] + 72) == 1) || (((mem[1152921520216181680] + 273) & 1) != 0)) || ((mem[1152921520216181680] + 273) == 0))
            {
                goto label_25;
            }
            ...
            if((mem[1152921520216181680] + 294) == 0)
            {
                goto label_36;
            }
            
            var val_19 = mem[1152921520216181680] + 176;
            var val_20 = 0;
            val_19 = val_19 + 8;
            label_35:
            if(((mem[1152921520216181680] + 176 + 8) + -8) == (mem[1152921520216181688] + 24))
            {
                goto label_34;
            }
            ...
            val_20 = val_20 + 1;
            val_19 = val_19 + 16;
            if(val_20 < (mem[1152921520216181680] + 294))
            {
                goto label_35;
            }
            ...
            goto label_36;
            label_26:
            if(((mem[1152921520216181688] + 72) == 1) || ((mem[1152921520216181688] + 72) == 0))
            {
                goto label_45;
            }
            ...
            goto label_44;
            label_27:
            UnityEngine.Sprite val_10 = mem[1152921520216181688].disabledSprite;
            label_45:
            label_25:
            val_22 = val_22 + 1;
            if(val_22 != val_13)
