...
public sealed class WordGameEventsController.ProxyEventHandlerDelegate : MulticastDelegate
{
    ...
    {
        mem[1152921516399003232] = object;
        mem[1152921516399003240] = method;
        mem[1152921516399003216] = method;
    }
    public virtual object Invoke(ref System.Collections.Generic.List<WGEventHandler> existingEventHandlers)
    {
        ...
        goto label_27;
        label_29:
        if((mem[1152921516399131544] & 1) == 0)
        {
            goto label_14;
        }
        
        if((mem[1152921516399131544] + 74) != 1)
        {
            goto label_20;
        }
        ...
        goto label_28;
        label_14:
        if(mem[1152921516399131536] == 0)
        {
            goto label_17;
        }
        
        if((((mem[1152921516399131544] + 72) == 1) || (((mem[1152921516399131536] + 273) & 1) != 0)) || ((mem[1152921516399131536] + 273) == 0))
        {
            goto label_20;
        }
        ...
        if((mem[1152921516399131536] + 294) == 0)
        {
            goto label_26;
        }
        
        var val_11 = mem[1152921516399131536] + 176;
        var val_12 = 0;
        val_11 = val_11 + 8;
        label_25:
        if(((mem[1152921516399131536] + 176 + 8) + -8) == (mem[1152921516399131544] + 24))
        {
            goto label_24;
        }
        ...
        val_12 = val_12 + 1;
        val_11 = val_11 + 16;
        if(val_12 < (mem[1152921516399131536] + 294))
        {
            goto label_25;
        }
        ...
        goto label_26;
        label_20:
        val_11 = mem[1152921516399131536];
        goto label_27;
        label_17:
        UnityEngine.Sprite val_4 = mem[1152921516399131544].disabledSprite;
        label_28:
        val_11 = 1152921516399163504;
        label_27:
        val_13 = val_13 + 1;
        if(val_13 != val_7)
        {
