...
{
    public class WUTAutopilotGameplay : AutopilotGameplay
    {
        // Fields
        private Pan pan;
        ...
        public override void OnSceneLoaded(SceneType sceneType)
        {
            ...
            val_6.onLevelComplete.AddListener(call:  new UnityEngine.Events.UnityAction(object:  this, method:  public System.Void twelvegigs.Autopilot.WUTAutopilotGameplay::HandleLevelComplete()));
        }
        public override void OnSceneUnloaded(SceneType sceneType)
        {
            ...
            val_1.onLevelComplete.RemoveListener(call:  new UnityEngine.Events.UnityAction(object:  this, method:  public System.Void twelvegigs.Autopilot.WUTAutopilotGameplay::HandleLevelComplete()));
        }
        public void HandleLevelComplete()
        {
            ...
            else
            {
                ...
                val_15 = ChapterBookLogic.ShowBookComplete(playerLevel:  App.Player);
            }
            ...
            if(val_15 != false)
            {
                ...
                val_18 = "Button_BookSelected_TapToContinue";
            }
            else
            {
                    if(val_16 != false)
            {
                    val_19 = "ChapterClear_collect_button";
            }
            else
            {
                    val_19 = "click_to_continue";
            }
            
                val_17 = public System.Void System.Collections.Generic.List<System.String>::Add(System.String item);
            }
            
            val_12.Add(item:  val_19);
            val_12.Add(item:  "WAD_Button_Green_Continue");
