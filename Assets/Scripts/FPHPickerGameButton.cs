...
public class FPHPickerGameButton : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        val_1.m_OnClick.AddListener(call:  new UnityEngine.Events.UnityAction(object:  this, method:  public System.Void FPHPickerGameButton::OnClick()));
    ...
    private System.Collections.IEnumerator doReveal(bool selected)
    {
        ...
        .<>4__this = this;
        .selected = selected;
        return (System.Collections.IEnumerator)new FPHPickerGameButton.<doReveal>d__14();
    }
