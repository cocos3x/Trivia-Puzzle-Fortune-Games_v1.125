using UnityEngine;
private sealed class WordMemoryUIController.<DelayFaceDownPair>d__18 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public WordMemoryUIController.<DelayFaceDownPair>d__18(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        ((0 + (this.card1) << 3) + (this.card2) << 3) + 32.FaceDown();
