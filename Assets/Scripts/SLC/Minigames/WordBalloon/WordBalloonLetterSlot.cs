...
namespace SLC.Minigames.WordBalloon
{
    public class WordBalloonLetterSlot : MonoBehaviour
    {
        ...
        {
            return (SLC.Minigames.WordBalloon.WordBalloonLetterTile)this.letterTile;
        }
        ...
        {
            mem[1152921519860773256] = link.above;
            this.SlotLink = link.left;
        }
