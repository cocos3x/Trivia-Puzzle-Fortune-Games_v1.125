...
public class LeaderboardPlayerInfo
{
    ...
    private string <portrait>k__BackingField;
    ...
    public virtual string get_portrait()
    {
        return (string)this.<portrait>k__BackingField;
    }
    public virtual void set_portrait(string value)
    {
        this.<portrait>k__BackingField = value;
    }
    public virtual string get_fbid()
    {
        return (string)this.<fbid>k__BackingField;
    }
