using UnityEngine;
public class PortraitCollectionLobbyButton : FrameSkipper
{
    // Fields
    private UnityEngine.UI.Text buttonText;
    private UnityEngine.GameObject rewardReadyIcon;
    ...
    private void Start()
    {
        mem[1152921516634588456] = new System.Action(object:  this, method:  System.Void PortraitCollectionLobbyButton::CheckState());
        mem[1152921516634588448] = 20;
        this.myButton = this.gameObject.GetComponent<UnityEngine.UI.Button>();
        UnityEngine.Vector2 val_6 = new UnityEngine.Vector2(x:  160f, y:  170.9f);
        this.gameObject.GetComponent<UnityEngine.RectTransform>().sizeDelta = new UnityEngine.Vector2() {x = val_6.x, y = val_6.y};
        UnityEngine.Vector2 val_8 = new UnityEngine.Vector2(x:  120f, y:  120f);
        this.portraitImage.rectTransform.sizeDelta = new UnityEngine.Vector2() {x = val_8.x, y = val_8.y};
        UnityEngine.Vector2 val_10 = new UnityEngine.Vector2(x:  0f, y:  8f);
        this.portraitImage.rectTransform.anchoredPosition = new UnityEngine.Vector2() {x = val_10.x, y = val_10.y};
        UnityEngine.Vector2 val_12 = new UnityEngine.Vector2(x:  0f, y:  64f);
        this.buttonText.rectTransform.sizeDelta = new UnityEngine.Vector2() {x = val_12.x, y = val_12.y};
        UnityEngine.Vector2 val_14 = new UnityEngine.Vector2(x:  0f, y:  0f);
        this.buttonText.rectTransform.anchorMin = new UnityEngine.Vector2() {x = val_14.x, y = val_14.y};
        UnityEngine.Vector2 val_16 = new UnityEngine.Vector2(x:  1f, y:  0f);
        this.buttonText.rectTransform.anchorMax = new UnityEngine.Vector2() {x = val_16.x, y = val_16.y};
        UnityEngine.Vector2 val_18 = new UnityEngine.Vector2(x:  0.5f, y:  0.25f);
        this.buttonText.rectTransform.pivot = new UnityEngine.Vector2() {x = val_18.x, y = val_18.y};
        UnityEngine.Vector2 val_20 = new UnityEngine.Vector2(x:  0f, y:  0f);
        this.buttonText.rectTransform.anchoredPosition = new UnityEngine.Vector2() {x = val_20.x, y = val_20.y};
    }
    private void CheckState()
    {
        ...
        val_43 = new UnityEngine.Events.UnityAction(object:  this, method:  System.Void PortraitCollectionLobbyButton::OpenCollection());
        ...
        return;
        label_28:
        val_43 = new UnityEngine.Events.UnityAction(object:  this, method:  System.Void PortraitCollectionLobbyButton::OpenEventStart());
        this.myButton.m_OnClick.AddListener(call:  new UnityEngine.Events.UnityAction());
        val_46 = "EVENT";
        goto label_48;
        label_30:
    ...
    private void OpenEventStart()
    {
        ...
        goto mem[(1152921504946249728 + (public PortraitCollectionEventStartPopup MetaGameBehavior::ShowUGUIMonolith<PortraitCollectionEventStartPopup>(bool showNext).__il2cppRuntimeField_48) << 4) + 312];
    }
    private void OpenCollection()
    {
        GameBehavior val_1 = App.getBehavior;
        goto mem[(1152921504946249728 + (public PortraitCollectionEventPopup MetaGameBehavior::ShowUGUIMonolith<PortraitCollectionEventPopup>(bool showNext).__il2cppRuntimeField_48) << 4) + 312];
    }
    public PortraitCollectionLobbyButton()
    {
