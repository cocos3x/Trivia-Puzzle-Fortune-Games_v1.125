...
public class GoldenApplesStatView : CurrencyStatView
{
    ...
    private void OnStarsUpdated(Notification notif)
    {
        ...
        var val_3 = val_4 & 1;
        goto typeof(GoldenApplesStatView).__il2cppRuntimeField_180;
    }
    ...
    {
        WGWindowManager val_2 = MonoSingleton<WGWindowManager>.Instance.ShowUGUIMonolith<WGGoldenApplesInfoPopup>(showNext:  false);
    }
