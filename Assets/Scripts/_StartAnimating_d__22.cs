using UnityEngine;
private sealed class TournamentsResultsPopup.<StartAnimating>d__22 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public TournamentsResultsPopup.<StartAnimating>d__22(int <>1__state)
    {
