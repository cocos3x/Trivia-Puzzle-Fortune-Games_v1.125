...
private sealed class AutopilotRequester.<Screenshot>d__12 : IEnumerator<object>, IEnumerator, IDisposable
{
    ...
    private bool MoveNext()
    {
        ...
        label_1:
        this.<>1__state = 0;
        this.<>4__this.AddScreenShoot(actionTimestamp:  this.actionTimestamp, uniqueTag:  this.uniqueTag, game:  this.game, file:  twelvegigs.Autopilot.AutopilotTools.TakeScreenshot());
