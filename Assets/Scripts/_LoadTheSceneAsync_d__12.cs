using UnityEngine;
private sealed class ScreenFaderV2.<LoadTheSceneAsync>d__12 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    private int <>1__state;
    private object <>2__current;
    public ScreenFaderV2 <>4__this;
    ...
    // Methods
    public ScreenFaderV2.<LoadTheSceneAsync>d__12(int <>1__state)
    {
