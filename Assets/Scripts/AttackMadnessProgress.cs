...
public class AttackMadnessProgress : EventProgression
{
    ...
    {
        string val_1 = UnityEngine.PlayerPrefs.GetString(key:  "evt_atkmad_prg", defaultValue:  0);
        if((System.String.IsNullOrEmpty(value:  val_1)) == true)
        {
                return;
        }
        
        AttackMadnessProgress val_3 = Newtonsoft.Json.JsonConvert.DeserializeObject<AttackMadnessProgress>(value:  val_1);
    ...
    {
        UnityEngine.PlayerPrefs.SetString(key:  "evt_atkmad_prg", value:  Newtonsoft.Json.JsonConvert.SerializeObject(value:  this));
        bool val_2 = PrefsSerializationManager.SavePlayerPrefs();
    }
    public override void Delete()
    {
        if((UnityEngine.PlayerPrefs.HasKey(key:  "evt_atkmad_prg")) != false)
        {
                UnityEngine.PlayerPrefs.DeleteKey(key:  "evt_atkmad_prg");
        }
