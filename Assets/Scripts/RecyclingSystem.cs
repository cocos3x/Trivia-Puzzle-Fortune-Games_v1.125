...
public abstract class RecyclingSystem
{
    ...
    {
        return (float)this.<CellWidth>k__BackingField;
    }
    protected void set_CellWidth(float value)
    {
        this.<CellWidth>k__BackingField = value;
    }
    public float get_CellHeight()
    {
        return (float)this.<CellHeight>k__BackingField;
    }
    protected void set_CellHeight(float value)
    {
        this.<CellHeight>k__BackingField = value;
    }
