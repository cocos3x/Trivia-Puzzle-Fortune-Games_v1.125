...
private sealed class LimitedTimeBundlesPopup.<StartFoodAnim>d__22 : IEnumerator<object>, IEnumerator, IDisposable
{
    ...
    private bool MoveNext()
    {
        ...
        this.<>4__this.foodAnimControl.Play(fromValue:  this.fromAmount, toValue:  new System.Decimal() {flags = val_2.flags, hi = val_2.hi, lo = val_2.lo, mid = val_2.mid}, textTickTime:  -1f, delayBeforeComplete:  -1f, destinationObject:  0, originObject:  0);
        label_2:
        val_4 = 0;
        return (bool)val_4;
    }
